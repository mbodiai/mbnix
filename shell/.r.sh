...
export CLICOLOR=1
export BAT_STYLE="header,grid,numbers,changes"
alias bat="$BAT --style=$BAT_STYLE --color=always --theme=1337 -l=python"
alias becho="$BAT --color=always --theme=1337 -l=bash --plain"
